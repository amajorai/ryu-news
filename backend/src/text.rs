...
pub const STOPWORDS: &[&str] = &[
    ...
    "few", "for", "from", "further", "get", "give", "had", "has", "have", "having", "he", "her",
    "here", "hers", "herself", "him", "himself", "his", "how", "i", "if", "in", "into", "is", "it",
    "its", "itself", "just", "latest", "like", "make", "many", "me", "more", "most", "my",
    "myself", "new", "news", "no", "nor", "not", "now", "of", "off", "on", "once", "one", "only",
    "or", "other", "others", "ought", "our", "ours", "ourselves", "out", "over", "own", "please",
    "report", "reports", "said", "same", "say", "says", "she", "should", "so", "some", "such",
    "take", "tell", "than", "thanks", "that", "the", "their", "theirs", "them", "themselves",
    "then", "there", "these", "they", "this", "those", "through", "to", "too", "under", "until",
    "up", "us", "very", "was", "we", "were", "what", "whats", "when", "where", "which", "while",
...
pub const ENTITY_STOPWORDS: &[&str] = &[
    "april", "august", "december", "february", "friday", "january", "july", "june", "march",
    "may", "monday", "november", "october", "saturday", "september", "sunday", "thursday",
    "tuesday", "wednesday",
];
...
mod tests {
    ...
    fn month_names_are_entity_stopwords_but_not_query_stopwords() {
        ...
        assert_eq!(query_tokens("January 6 hearings"), ["january", "6", "hearings"]);
    }

    #[test]
    fn normalize_lowercases_collapses_and_trims() {
        assert_eq!(normalize("  The\t Federal   Reserve\n"), "the federal reserve");
        assert_eq!(normalize(""), "");
        assert_eq!(normalize("   "), "");
