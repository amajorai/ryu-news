<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Wire" width="144" />
  </picture>
</p>
...
**App:** [Install](ryu://apps/@ryu/news) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/news
```

**Crate:**

```bash
cargo install ryu-news
```
